<div class="widget-layout {{$widgetData['width']}}{{$widgetData['custom_class']}} js-ak-widget-area{{$widgetData['disable_js']}}" id="{{$widgetData['id']}}"
...
>
    <div class="widget-content widget-area js-ak-widget-content">
