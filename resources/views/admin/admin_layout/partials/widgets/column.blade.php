<div class="widget-layout {{$widgetData['width']}}{{$widgetData['custom_class']}} js-ak-widget-column{{$widgetData['disable_js']}}" id="{{$widgetData['id']}}"
...
>
    <div class="widget-content widget-column js-ak-widget-content">
