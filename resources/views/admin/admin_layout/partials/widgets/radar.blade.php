<div class="widget-layout {{$widgetData['width']}}{{$widgetData['custom_class']}} js-ak-widget-radar{{$widgetData['disable_js']}}" id="{{$widgetData['id']}}"
...
>
    <div class="widget-content widget-radar js-ak-widget-content">
